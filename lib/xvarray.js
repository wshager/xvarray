...
function array(...a) {
	...
	return (0, _xvseq.seq)((0, _immutable.List)(a.map(_ => (0, _xvseq._isSeq)(_) && _.size > 1 ? _ : (0, _xvseq._first)(_))));
}
...
function _wrap(fn, fltr) {
	return function (v, i) {
		...
		return !fltr && (0, _xvseq._isSeq)(ret) && ret.size > 1 ? ret : (0, _xvseq._first)(ret);
	};
}
