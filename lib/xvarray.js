...
function array() {
	...
	if (l == 1 && (0, _xvseq._isSeq)(a[0])) {
		return (0, _xvseq.seq)((0, _immutable.List)(a[0].map(function (_) {
			return (0, _xvseq.seq)(_);
		})));
	}
	return (0, _xvseq.seq)((0, _immutable.List)(a.map(function (_) {
		return (0, _xvseq.seq)(_);
	})));
}
...
function filter() {
	...
	var a = (0, _xvseq._first)(args[0]);
	if (!_isArray(a)) return error("XPTY0004");
	return (0, _xvseq.seq)(a.filter((0, _xvseq._wrapFilter)(fn)));
}
