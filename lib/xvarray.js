...
function array(...a) {
	...
	if (l == 1 && (0, _xvseq._isSeq)(a[0])) {
		return (0, _xvseq.seq)((0, _immutable.List)(a[0].flatten(true).toArray().map(_ => (0, _xvseq._isSeq)(_) && _.size > 1 ? _ : (0, _xvseq._first)(_))));
	}
	return (0, _xvseq.seq)((0, _immutable.List)(a.map(_ => (0, _xvseq._isSeq)(_) && (_.isEmpty() || _.size > 1) ? _ : (0, _xvseq._first)(_))));
}
...
function insertBefore($a, $i, $v) {
	...
	return _checked($a, ListProto.insert, i - 1, (0, _xvseq._isSeq)($v) && $v.size > 1 ? $v : (0, _xvseq._first)($v));
}

function _wrap(fn, fltr) {
	return function (v, i) {
		var ret = fn((0, _xvseq.seq)(v));
		return !fltr && (0, _xvseq._isSeq)(ret) && (ret.isEmpty() || ret.size > 1) ? ret : (0, _xvseq._first)(ret);
	};
}
...
function forEach(...args) {
	...
	if (!_isArray(a)) return (0, _xverr.error)("XPTY0004");
	return (0, _xvseq.seq)(a.map(_wrap(fn)));
}
...
function filter(...args) {
	...
	var a = (0, _xvseq._first)(args[0]);
	if (!_isArray(a)) return (0, _xverr.error)("XPTY0004");
	return (0, _xvseq.seq)(a.filter(_wrap(fn, true)));
}
...
function append(...args) {
	...
	var insert = args[1];
	if (!_isArray(a)) return (0, _xverr.error)("XPTY0004");
	if ((0, _xvseq._isSeq)(insert) && !insert.isEmpty()) {
		insert = insert.size > 1 ? insert : (0, _xvseq._first)(insert);
	}
	return (0, _xvseq.seq)(a.push(insert));
}
...
function get($a, $index) {
	var a = (0, _xvseq._first)($a);
	// TODO throw
	var index = (0, _xvseq._first)($index).valueOf() - 1;
	if (a.isEmpty()) return (0, _xvseq.seq)();
	return (0, _xvseq.seq)(a.get(index));
}